...
<body>
  ...
  <?php if (isset($user)): ?>
    ...
    <?php endif; ?>
      ...
      <!---<button class="buttonWrapper" id="lobbyButton" onclick="document.location='shared_screen.php'"><span id="lobbySpan" style="font-family:symbols;">&#xE921;</span>Shared Screen Games</button><br>--->
      <?php if($_SESSION["role"]==="admin"):?>
